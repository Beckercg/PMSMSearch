...
double msmDistPruned(double *X, double *Y, int m, double bsf, double sakoe_bandwidth, double *tmpArray)
{
        ...
        } else
        {
            ...
            for(i=0; i<ep; i++)
            {
                ...
                if( i >= m-1 )
                {
                    ...
                    distCalc = msmDistPruned(tz,q,m,bsf,bandwidth, tmpArray);
