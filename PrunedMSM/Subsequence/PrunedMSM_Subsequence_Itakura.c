...
double msmDistPruned(double *X, double *Y, int m, int n, double slope, double *tmpArray, double *upperBoundArray)
{
        ...
        } else
        {
            ...
            for(i=0; i<ep; i++)
            {
                ...
                if( i >= m-1 )
                {
                    ...
                    distCalc = msmDistPruned(tz,q,m,m,slope,tmpArray, upperBoundArray);
